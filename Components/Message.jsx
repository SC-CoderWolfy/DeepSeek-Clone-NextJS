                ...
                <div className={`group relative flex max-w-2xl py-3 rounded-xl ${role === 'user' ? 'bg-[#414158] px-5' : 'gap-3'}`}>
                    ...
                    <div className={`opacity-0 group-hover:opacity-100 absolute ${role === 'user' ? '-left-16 top-2.5' : 'left-9 -bottom-6'} transition-all`}>
                        ...
                        <div className='flex items-center gap-2 opacity-70'>
                            ...
                            {role === 'user' ? (<><Image src={assets.copy_icon} alt='' className='w-4 cursor-pointer ' />
                    ...
                    {role === 'user' ? (<span className='text-white/90'> {content}</span>) : (<>
                        ...
                        <Image src={assets.logo_icon} alt='' className='h-9 w-9 border border-white/15 rounded-full' />
